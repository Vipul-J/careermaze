...
import demoPic from '../assets/images/demoPic.png'
import vipulJ from '../assets/images/vipulJ.jpeg' 
import aishP from '../assets/images/aishP.jpg'

import harryV from '../assets/images/harryV.jpeg' 
import kraj from '../assets/images/kraj.jpeg' 
import shreedevi from '../assets/images/shreedevi.jpeg' 
import spoorti from '../assets/images/spoorti.jpeg' 
import soniya from '../assets/images/soniya.jpeg' 
import shree from '../assets/images/shree.jpeg' 
import veeresh from '../assets/images/veeresh.jpeg' 
import sada from '../assets/images/sada.jpeg' 
import akhil from '../assets/images/akhil.jpeg'  
import adiS from '../assets/images/adiS.jpeg' 
import hemya from '../assets/images/hemya.jpeg' 
import aishC from '../assets/images/aishC.jpeg' 
import muskan from '../assets/images/muskan.jpeg' 
import shreyD from '../assets/images/shreyD.jpeg' 
import duanshiS from '../assets/images/duanshiS.jpeg'
import sidduK from '../assets/images/sidduK.jpeg'
import rahulA from '../assets/images/rahulA.jpg'
import vishwaN from '../assets/images/vishwaN.jpeg'
import niks from '../assets/images/niks.jpeg'
import sunilS from '../assets/images/sunilS.jpeg'
import { faInstagramSquare, faLinkedin, faSquareWhatsapp } from "@fortawesome/free-brands-svg-icons";
                ...
                <div class="row ">
                    ...
                    <div class="col-sm mb-4">
                        <div class="card card-team darkblue-txt">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Duanshi Shah</h5>
                                <p class="card-text fw-bold fs-5">Placement Secretary</p>
                                <a class="text-decoration-none darkblue-txt fw-bold" href='https://wa.me/9591074133'>  <FontAwesomeIcon icon={faSquareWhatsapp} size='2xl' /></a>
                    ...
                    <div class="col-6 col-sm-3 col-md-3 col-lg-3">
                        <div class="card card-team darkblue-txt">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text fw-bold">Placement Co-ordinator</p>
...
'>  <FontAwesomeIcon icon={faSquareWhatsapp} size='2xl' /></a>
                    ...
                    <div class="col-6 col-sm-3 col-md-3 col-lg-3">
                        <div class="card card-team darkblue-txt">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text fw-bold">Placement Co-ordinator</p>
                                <a class="text-decoration-none darkblue-txt fw-bold" href='#'>  <FontAwesomeIcon icon={faSquareWhatsapp} size='2xl' /></a>
                    ...
                    <div class="col-6 col-sm-3 col-md-3 col-lg-3">
                        <div class="card card-team darkblue-txt">
                            <img src={demoPic} class="card-img-top" alt="" />
                            <div class="card-body">
                    ...
                    <div class="col-6 col-sm-3 col-md-3 col-lg-3">
                        <div class="card card-team darkblue-txt">
                            <img src={demoPic} class="card-img-top" alt="" />
                            <div class="card-body">
                                <h5 class="card-title">Deepa Desali</h5>
                                <p class="card-text fw-bold">Placement Co-ordinator</p>
                                <a class="text-decoration-none darkblue-txt fw-bold" href='#'>  <FontAwesomeIcon icon={faSquareWhatsapp} size='2xl' /></a>
                                <a class="text-decoration-none darkblue-txt fw-bold" href='#'>  <FontAwesomeIcon icon={faLinkedin} size='2xl' /></a>
                                <a class="text-decoration-none darkblue-txt fw-bold" href='#'>  <FontAwesomeIcon icon={faInstagramSquare} size='2xl' /></a>
